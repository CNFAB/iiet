...
<header class="mb-5">
	<div class="navbar navbar-dark navbar-expand-lg">
		<div class="container-fluid">
			<h2 class="col-6">Consultas por Campa&ntilde;as</h2>
...
<section class="container pb-5">
	<form name="formRestricciones">
		<fieldset class="form-group">
			<legend class="col-form-legend">Restricci&oacute;n por Nombre o Lugar</legend>
			<div class="form-row">
				<div class="col-4">
					<fieldset class="form-group">
						<legend class="col-form-legend">Por Nombre</legend>
						<div class="form-row">
							<div class="col">
								<ul id="list-camp-datos-sel" class="lista-datos-sel list-group list-group-flush mb-2">
									<li class="item-vacio">
										<p>No hay datos seleccionados</p>
									</li>
								</ul>
								<div class="text-right">
									<button type="button" class="btn btn-primary fas fa-edit fa-1x fa-1x" title="Editar" data-toggle="modal" data-target="#consult-selec-campania" data-keyboard="false" data-backdrop="static"></button>
								</div>
							</div>
						</div>
					</fieldset>
...
<header class="mb-4 d-none">
	<div class="navbar navbar-dark navbar-expand-lg">
		<div class="container-fluid">
			<h2 class="col-9">Consultas por Campa&ntilde;as</h2>
			<button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#links">
				<span class="navbar-toggler-icon"></span>
			</button>
...
<section class="container-fluid pr-4 pb-4 pl-4 d-none">
	...
	<form action="/iiet/consultas/exportar_consulta_campanias/" method="POST" name="formCamposConsulta">
				...
				<div class="card-columns">
					<fieldset class="card p-0 bg-dark">
						<div class="card-header">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="checkbox-campania" checked>
								<label class="custom-control-label font-weight-bold" for="checkbox-campania">CAMPA&Ntilde;A</label>
							</div>
						</div>
						<div class="card-body">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="campania_nombre" class="custom-control-input" id="campania-nombre" checked>
								<label class="custom-control-label" for="campania-nombre">Nombre</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="campania_fecha" class="custom-control-input" id="campania-fecha" checked>
								<label class="custom-control-label" for="campania-fecha">Fecha</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="departamento" class="custom-control-input" id="campania-departamento" checked>
								<label class="custom-control-label" for="campania-departamento">Departamento</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="localidad" class="custom-control-input" id="campania-localidad" checked>
								<label class="custom-control-label" for="campania-localidad">Localidad</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="barrio" class="custom-control-input" id="campania-barrio" checked>
								<label class="custom-control-label" for="campania-barrio">Barrio</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="paraje" class="custom-control-input" id="campania-paraje" checked>
								<label class="custom-control-label" for="campania-paraje">Paraje</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="puesto" class="custom-control-input" id="campania-puesto" checked>
								<label class="custom-control-label" for="campania-puesto">Puesto</label>
							</div>
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="institucion" class="custom-control-input" id="campania-institucion" checked>
								<label class="custom-control-label" for="campania-institucion">Instituci&oacute;n</label>
							</div>
						</div>
					</fieldset>
					<fieldset class="card p-0 mt-3 bg-dark">
						<div class="card-header">
							<div class="custom-control custom-checkbox">
...
<script src="/iiet/assets/js/consultas_campanias.js"></script>
</html>