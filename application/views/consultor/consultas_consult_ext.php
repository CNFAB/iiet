...
<html lang="es">
<head>
	<title>Consultas por Consultorio Externo</title>
	<meta charset="utf-8"/>
...
<header class="mb-5">
	<div class="navbar navbar-dark navbar-expand-lg">
		<div class="container-fluid">
			<h2 class="col-6">Consultas por Consultorio Externo</h2>
			...
			<div id="links" class="navbar-collapse collapse justify-content-end">
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a class="nav-link active" href="#">Consultorio Externo</a>
					</li>
...
<header class="mb-4 d-none">
	<div class="navbar navbar-dark navbar-expand-lg">
		<div class="container-fluid">
			<h2 class="col-9">Consultas por Consultorio Externo</h2>
			<button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#links">
				<span class="navbar-toggler-icon"></span>
			</button>
...
<section class="container-fluid pr-4 pb-4 pl-4 d-none">
	...
	<form action="/iiet/consultas/exportar_consulta_ambulatorio/" method="POST" name="formCamposConsulta">
