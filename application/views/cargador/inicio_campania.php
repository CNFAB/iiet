...
<html lang="es">
<head>
	<title>Campa&ntilde;a Inicio</title>
	<meta charset="utf-8"/>
...
<header class="mb-4">
	<div class="navbar navbar-dark navbar-expand-lg">
		<div class="container-fluid">
			<h2 class="col-6 mb-0">Campa&ntilde;a: <span id="nombre-campania"></span></h2>
...
<section id="contenedor" class="container-fluid pr-5 pl-5">
	<div class="row justify-content-center h-100 align-items-center">
		<div class="col-3 h-75">
			<a href="/iiet/campanias/copro" id="copro" class="link btn" title="Coproparasitológico"></a>
		</div>
		<div class="col-3 h-75">
			<a href="/iiet/campanias/sangre" id="sangre" class="link btn btn-danger" title="Sangre"></a>
		</div>
		<div class="col-3 h-75">
			<a href="/iiet/campanias/biologia_molecular" id="biologmolec" class="link btn btn-success" title="Biología Molecular"></a>
		</div>
		<div class="col-3 h-75">
			<a href="/iiet/campanias/tratamiento" id="tratamiento" class="link btn btn-primary" title="Tratamiento"></a>
		</div>
	</div>
</section>
</body>
...
<script src="/iiet/assets/js/config-view-ini-campania.js" type="module"></script>
</html>